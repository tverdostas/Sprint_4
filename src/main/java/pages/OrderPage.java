...
public class OrderPage {
    ...
    /**
     * Ячейка списка доступных станций метро
     */
    ...
    /**
     * Ячейка для выпадающего списка по срочности аренды
     */
    ...
    /**
     * Конструктор класса OrderPage. Создает новый экземпляр страницы заказа
     *
    ...
    /**
     * Метод для выбора значения в поле "Станция метро"
     *
    ...
    /**
     * Метод для выбора значения в поле "Дата"
     *
    ...
    /**
     * Метод для выбора значения в поле "Срочность аренды"
     *
    ...
    /**
     * Метод для выбора значения в поле "Цвет"
     *
    ...
    /**
     * Метод для ввода значения в поле "Комментарий"
     *
    ...
    /**
     * Метод для нажатия на кнопку "Да" на форме "Хотите оформить заказ?"
     */
