...
public class MainPage {
    ...
    /**
     * Метод для проверки раскрытия блока аккордеона с вопросами
     *
     * @param index порядковый номер элемента аккордеона
