...
public class MainPageLinksTests {
    ...
    public void checkYandexLinkIsCorrect() {
        ...
        assertTrue(
                "Ссылка на логотипе Яндекса не ведёт на страницу " + this.yandexUrl,
                mainPage.getYandexLogoLink().contains(this.yandexUrl)
        );

        assertTrue(
                "Ссылка на логотипе Яндекса не открывается в новой вкладке",
    ...
    public void checkScooterLinkIsCorrect() {
        ...
        assertTrue(
                "Логотип Самоката не ведёт на страницу " + this.scooterUrl,
